...
export default function FloatingWhatsApp() {
  ...
  return (
    <motion.a
      ...
      className="fixed bottom-6 right-6 z-40 flex h-16 w-16 items-center justify-center rounded-full bg-gold text-ink shadow-[0_8px_30px_rgba(0,0,0,0.25)] transition-colors hover:bg-gold-light md:h-[4.5rem] md:w-[4.5rem]"
      aria-label="WhatsApp"
    >
      <svg
        viewBox="0 0 24 24"
